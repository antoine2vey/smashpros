...
const characters = [
  ...
  character('Kazuya', 'https://ssb.wiki.gallery/images/8/85/KazuyaHeadSSBUWebsite.png'),
  ...
  character('Pyra & Mythra', 'https://ssb.wiki.gallery/images/7/7c/PyraHeadSSBUWebsite.png'),
